...
- For multi-agent orchestration, use Grok 4.6 extra high unless a stronger model is clearly required. Prefer Kimi K3 or GLM 5.2 when a different model is needed; elevate to Opus 5, Sonnet 5, or GPT 5.6 (sol/luna/terra) only when necessary.
...
- Shell and chrome UI text is not selectable; keep the content area copyable.
