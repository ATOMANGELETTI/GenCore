---
description: Draft a commitlint-compliant conventional commit message and commit with user confirmation
---
...
2. Draft a conventional commit message strictly adhering to repository rules:
   ...
   - Strictly NO AI attribution trailers (`Co-authored-by: Cursor`, `Made-with: Cursor`, `Generated-by: Cursor`, `Assisted-by: AI`, or any Claude/Copilot/ChatGPT equivalent).
