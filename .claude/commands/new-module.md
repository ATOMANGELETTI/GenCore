---
description: Scaffold a new module following the modular-naming convention
argument-hint: [package/app/crate] [module-name]
---
...
see the security baseline and Rust conventions in the root `AGENTS.md`. Run the relevant
typecheck/test/lint command for the affected package or crate before finishing.
