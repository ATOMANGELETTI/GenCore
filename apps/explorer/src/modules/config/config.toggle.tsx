...
/**
 * Minimal accessible switch, local to the explorer's Config tab. `ui-kit` has
 * no Switch primitive yet — this is the first boolean setting in the product,
 * so it stays local rather than prematurely generalized.
 */
