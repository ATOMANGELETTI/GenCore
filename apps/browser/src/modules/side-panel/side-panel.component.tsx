import { Button, cn, Tooltip, TooltipContent, TooltipTrigger } from "@gencore/ui-kit";
import { Download, History as HistoryIcon, type LucideIcon, Settings, Star } from "lucide-react";
import * as React from "react";
import type { Bookmark } from "../bookmarks/bookmarks.types";
import { BookmarksPanel } from "../bookmarks/bookmarks-panel.component";
import { Config } from "../config/config.component";
import type { DownloadEntry } from "../downloads/downloads.types";
import { DownloadsPanel } from "../downloads/downloads-panel.component";
import type { HistoryEntry } from "../history/history.types";
...
const TABS: readonly { id: SidePanelTabId; label: string; Icon: LucideIcon }[] = [
...
export function SidePanel({
  ...
  const [selected, setSelected] = React.useState<SidePanelTabId>("bookmarks");
        ...
        {TABS.map((tab) => (
          ...
          >
            {tab.id === "bookmarks" ? (
              ...
              <HistoryPanel entries={historyEntries} onOpen={onOpenUrl} />
            ) : tab.id === "downloads" ? (
              <DownloadsPanel downloads={downloads} />
            ) : tab.id === "config" ? (
              <Config onClearBrowsingData={onClearBrowsingData} />
            ) : null}
          </div>
        ))}
      </div>
