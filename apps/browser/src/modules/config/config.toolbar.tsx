...
import { Check, ChevronDown, type LucideIcon, Palette, SlidersHorizontal } from "lucide-react";
...
export function ConfigToolbar({ activeSubview, onSelectSubview }: ConfigToolbarProps) {
