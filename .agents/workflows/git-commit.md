---
name: "git-commit"
description: "Draft a commitlint-compliant conventional commit message and quickly commit changes with user confirmation."
---

<!-- Generated from .cursor/commands/git-commit.md by `pnpm sync:agents`. Do not edit. -->
