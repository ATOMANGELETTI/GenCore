...
<!-- Generated from .cursor/skills/add-crate-module/SKILL.md by `pnpm sync:agents`. Do not edit. -->
...
5. Decide stub vs. real: if the UI doesn't call this command yet, implement it as a
   ...
   until the UI actually invokes it (see `security` and `tauri-rust` rules).
