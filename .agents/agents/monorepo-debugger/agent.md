...
description: "Diagnoses turbo/pnpm/cargo workspace failures — dependency resolution, workspace graph mismatches, and build/test pipeline breaks across GenCore."
subagent: true
mainAgent: false
tools:
  - "view_file"
...
<!-- Generated from .cursor/agents/monorepo-debugger.md by `pnpm sync:agents`. Do not edit. -->
...
5. Cross-reference the `architecture` rule for the expected graph shape before
